...
impl RustGame {
    ...
    fn self_play_net(
        ...
        let cfg = make_self_play_config(
            ...
            full_sims_max,
            full_search_fraction,
            0, // full_search_every_games: gates and arenas never do this
            top_k,
            draft_prior,
            c_puct,
            c_visit,
...
#[pyo3(signature = (
    ...
    draft_prior, full_search_every_games=0, iteration=None, c_puct=1.5, c_visit=50.0, c_scale=0.1,
